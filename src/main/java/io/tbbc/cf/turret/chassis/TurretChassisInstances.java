...
public class TurretChassisInstances {
    ...
    public static final TurretChassis M_PULSE = new TurretChassis("m_pulse", "Pulse",
            ...
            Stream.of(ARG_M_PULSE, TEL_M_PULSE, PAR_M_PULSE, XEN_M_PULSE).sorted(Comparator.comparing(ChassisSkin::label)).toList());
    public static final TurretChassis M_GATLING = new TurretChassis("m_gatling", "Gatling",
            ...
            Stream.of(ARG_M_GATLING, TEL_M_GATLING, PAR_M_GATLING).sorted(Comparator.comparing(ChassisSkin::label)).toList());
    public static final TurretChassis M_PLASMA = new TurretChassis("m_plasma", "Plasma",
            ...
            new ChassisPropsStandard(50, 660, 2, 1, 4.2,
                    ...
                    8, 10),
            Stream.of(ARG_M_PLASMA, TEL_M_PLASMA, PAR_M_PLASMA).sorted(Comparator.comparing(ChassisSkin::label)).toList());
    public static final TurretChassis M_SHOTGUN = new TurretChassis("m_shotgun", "Shotgun",
            ...
            new ChassisPropsStandard(108, 660, 2, 5, 1.2,
                    ...
                    10, 2, 6, 9),
            Stream.of(ARG_M_SHOTGUN, TEL_M_SHOTGUN, PAR_M_SHOTGUN).sorted(Comparator.comparing(ChassisSkin::label)).toList());
    public static final TurretChassis M_BEAM = new TurretChassis("m_beam", "Beam",
            ...
            new ChassisPropsBeam(80, 660, 3, 1, 72, 72,
                    2550, 10, 6, 10, 10),
            Stream.of(ARG_M_BEAM, TEL_M_BEAM, PAR_M_BEAM, XEN_M_BEAM).sorted(Comparator.comparing(ChassisSkin::label)).toList());
    // Large
    public static final TurretChassis L_PULSE = new TurretChassis("l_pulse", "Pulse",
            ...
            Stream.of(ARG_L_PULSE, TEL_L_PULSE, PAR_L_PULSE, XEN_L_PULSE, KHA_L_PULSE).sorted(Comparator.comparing(ChassisSkin::label)).toList());
    ...
    public static final TurretChassis L_PLASMA = new TurretChassis("l_plasma", "Plasma",
            ...
            new ChassisPropsStandard(33, 3000, 2, 1, 4.2,
                    ...
                    8, 32),
            Stream.of(ARG_L_PLASMA, TEL_L_PLASMA, PAR_L_PLASMA).sorted(Comparator.comparing(ChassisSkin::label)).toList());
    public static final TurretChassis L_BASE_BEAM = new TurretChassis("l_base_beam", "Beam",
            ...
            new ChassisPropsBeam(26, 3000, 5, 3, 147, 147,
                    5000, 10, 6, 10, 39),
            Stream.of(ARG_L_BEAM, TEL_L_BEAM, PAR_L_BEAM, KHA_L_BEAM).sorted(Comparator.comparing(ChassisSkin::label)).toList());
